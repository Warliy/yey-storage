...
import org.syncany.connection.plugins.picasa.PicasaConnection;
import org.syncany.connection.plugins.rackspace.RackspaceConnection;
import org.syncany.connection.plugins.s3.S3Connection;
import org.syncany.connection.plugins.samba.SambaConnection;
...
public class TestSpeed {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        final S3Connection c = new S3Connection();
        c.setAccessKey("...");
        c.setSecretKey("...");
        c.setBucket("pheckel-syncany");
        c.setLocation(S3Bucket.LOCATION_EUROPE);
        ...
        for (int filesize = 64; filesize <= 1024; filesize += 32) {
            ...
            for (int chunksize = 4; chunksize <= 32; chunksize *=2) {
                ...
                // SEQUENCE
            {
                MeasureThread[] threads = initThreads(c, chunkCount, chunksize);
                Thread.sleep(1000);
  ...
  // PARALLEL
                ...
                // SINGLE FILE
                {
                    MeasureThread[] threads = initThreads(c, 1, filesize);
                    Thread.sleep(1000);
