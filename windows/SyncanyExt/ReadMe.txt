========================================================================
    ACTIVE TEMPLATE LIBRARY : SyncanyExt Project Overview
========================================================================

AppWizard has created this SyncanyExt project for you to use as the starting point for
...
SyncanyExt.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (SyncanyExt.h)
        GUID definitions                                (SyncanyExt_i.c)
        A type library                                  (SyncanyExt.tlb)
        Marshaling code                                 (SyncanyExt_p.c and dlldata.c)

SyncanyExt.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in SyncanyExt.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named SyncanyExt.pch and a precompiled types file named StdAfx.obj.
...
SyncanyExtps.vcxproj
	...
	dlldata.c, SyncanyExt_i.c and SyncanyExt_p.c which are required
	to build the proxy/stub DLL.

SyncanyExtps.vcxproj.filters
